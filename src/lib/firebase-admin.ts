...
export async function verifySession(token: string | undefined) {
    ...
    try {
        ...
        // Verify admin role strictly from custom claims
        // Hardcoded email checks (e.g. admin@smartmotor.ae) have been removed for security.
        // Admins must have the custom claim { role: 'ADMIN' } set in Firebase.
