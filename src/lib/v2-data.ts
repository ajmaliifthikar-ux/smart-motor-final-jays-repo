...
import { BrandCategory, ServicePackage, BlogPost, AboutContent } from '@/types/v2'

// --- SERVICES (Fully Populated from Documentation) ---
...
// --- BRAND CATEGORIES (Updated Descriptions) ---
