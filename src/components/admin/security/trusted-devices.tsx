...
// Cached `Intl.DateTimeFormat().resolvedOptions().timeZone` at the module scope
// to prevent expensive `Intl` instantiation and resolution on every list item render.
