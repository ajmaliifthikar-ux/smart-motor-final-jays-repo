          ...
          <div className="lg:col-span-5">
            ...
            >
              <div>
                ...
                <h2 className={cn(
                  "text-5xl md:text-7xl font-black text-black tracking-tighter uppercase leading-none italic",
                  isRTL && "font-arabic not-italic tracking-normal text-6xl"
                )}>
                  {language === 'ar' ? 'ثقة' : 'TRUST'} <br />
                  <span className="silver-shine leading-none block">{language === 'ar' ? 'المحترفين' : 'VERIFIED'}</span>
                </h2>
              </div>

              <div className="p-8 bg-black rounded-[2.5rem] text-white italic shadow-2xl relative overflow-hidden micro-noise">
              ...
              <div className="flex gap-4">
                <button
                  onClick={handlePrev}
                  className="w-14 h-14 rounded-2xl border border-gray-200 flex items-center justify-center hover:bg-black hover:text-white transition-all group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black"
                  aria-label={language === 'ar' ? 'الشهادة السابقة' : 'Previous testimonial'}
                >
                ...
                <button
                  onClick={handleNext}
                  className="w-14 h-14 rounded-2xl border border-gray-200 flex items-center justify-center hover:bg-black hover:text-white transition-all group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black"
                  aria-label={language === 'ar' ? 'الشهادة التالية' : 'Next testimonial'}
                >
