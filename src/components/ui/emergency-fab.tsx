                ...
                {fabs.map((fab) => (
                    ...
                    >
                        <Tooltip content={fab.label} position="left">
                            <button
                                onClick={fab.onClick}
                                aria-label={fab.id === 'ai' ? (isChatOpen ? "Close AI Assistant" : "Open AI Assistant") : fab.label}
                                className={cn(
            ...
            <AnimatePresence>
                {showTowFlow && (
                    ...
                    >
                        ...
                        >
                            <button onClick={() => setShowTowFlow(false)} aria-label="Close towing interface" className="absolute top-6 right-6 z-50 p-2 bg-white rounded-full hover:bg-gray-100 transition-colors shadow-md">
                                <X size={20} />
                            </button>
