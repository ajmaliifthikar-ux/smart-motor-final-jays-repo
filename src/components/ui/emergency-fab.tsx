                    ...
                    >
                        <Tooltip content={fab.label} position="left">
                            <button
                                ...
                                className={cn(
                                    "w-14 h-14 rounded-full flex items-center justify-center shadow-xl transition-all duration-300 hover:scale-110 active:scale-95 relative overflow-hidden focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black",
                                    fab.color,
                                    fab.textColor,
            ...
            <AnimatePresence>
                {showTowFlow && (
                    ...
                    >
                        ...
                        >
                            <button onClick={() => setShowTowFlow(false)} aria-label="Close towing modal"
                                className="absolute top-6 right-6 z-50 p-2 bg-white rounded-full hover:bg-gray-100 transition-colors shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black">
                                <X size={20} />
                            </button>
