            ...
            <AnimatePresence>
                {showTowFlow && (
                    ...
                    >
                        ...
                        >
                            <button onClick={() => setShowTowFlow(false)} aria-label="Close Tow Flow" className="absolute top-6 right-6 z-50 p-2 bg-white rounded-full hover:bg-gray-100 transition-colors shadow-md">
                                <X size={20} />
                            </button>
