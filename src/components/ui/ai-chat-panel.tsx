                    ...
                    >
                        {msg.widget.type === 'confirmation' ? (
                            ...
                            <div className="relative flex items-center">
                                <input 
                                    autoFocus aria-label={`Enter ${msg.widget.type}`}
                                ...
                                />
                                <button 
                                    aria-label="Confirm" className="absolute right-2 w-8 h-8 bg-[#121212] text-white rounded-lg flex items-center justify-center hover:bg-[#E62329] transition-colors"
                                    onClick={(e) => {
