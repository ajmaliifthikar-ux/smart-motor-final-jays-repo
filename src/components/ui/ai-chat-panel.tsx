      ...
      {isOpen && (
        ...
        >
          ...
          <div className="bg-[#121212] px-6 py-6 flex items-center justify-between relative overflow-hidden">
            ...
            <button onClick={onClose} aria-label="Close chat panel" className="p-2.5 bg-white/5 hover:bg-[#E62329] rounded-full transition-all text-white/40 hover:text-white relative z-10">
              <X className="w-4 h-4" />
            </button>
          </div>
                    ...
                    >
                        {msg.widget.type === 'confirmation' ? (
                            ...
                            <div className="relative flex items-center">
                                ...
                                />
                                <button 
                                    aria-label={`Submit ${msg.widget.type}`}
