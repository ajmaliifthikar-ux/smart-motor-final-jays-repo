  ...
  return (
    <div className="min-h-screen bg-[#FAFAF9] flex items-center justify-center p-4">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div className="absolute -top-40 -right-40 w-[600px] h-[600px] rounded-full bg-[#E62329]/8 blur-[120px]" />
        <div className="absolute -bottom-40 -left-40 w-[500px] h-[500px] rounded-full bg-[#121212]/5 blur-[100px]" />
      </div>
      ...
      >
        ...
        <p className="text-center text-xs text-gray-400 mt-6 tracking-wide">
          Trusted by thousands of car owners across the UAE
        </p>
      </motion.div>
    </div>
  )
