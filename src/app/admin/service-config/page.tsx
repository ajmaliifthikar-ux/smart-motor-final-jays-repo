  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Service Booking Configuration</h1>
          <p className="text-gray-600 mt-2">
            Manage service availability, slots, and booking capacity
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="mb-4">
              ...
              <p className="text-sm text-gray-600">({configs.length} active)</p>
            </div>
            <ServiceConfigList
              configs={configs}
