...
// Hoisted Intl.NumberFormat to avoid expensive repeated instantiation during invoice renders.
...
// ⚡ Bolt Performance Optimization:
// Hoisted Intl.DateTimeFormat to avoid expensive repeated instantiation during invoice renders.
