...
// ⚡ Bolt Optimization: Hoist expensive Intl instantiations to module scope
...
const localDateFormatter = new Intl.DateTimeFormat('en-AE', { day: '2-digit', month: 'short', year: 'numeric' })
function formatDate(iso: string) {
  if (!iso) return '—'
  return localDateFormatter.format(new Date(iso + 'T00:00:00'))
}
