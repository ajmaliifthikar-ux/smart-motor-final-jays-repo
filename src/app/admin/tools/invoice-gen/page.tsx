...
// Hoist Intl formatters to module scope to avoid expensive instantiation on every call (~60-100x overhead reduction)
const moneyFormatter = new Intl.NumberFormat('en-AE', { minimumFractionDigits: 2, maximumFractionDigits: 2 });
