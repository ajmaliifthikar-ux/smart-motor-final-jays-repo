...
// ⚡ Bolt: Hoist Intl objects for better render performance
const invoiceMoneyFormatter = new Intl.NumberFormat('en-AE', { minimumFractionDigits: 2, maximumFractionDigits: 2 })
const invoiceDateFormatter = new Intl.DateTimeFormat('en-AE', { day: '2-digit', month: 'short', year: 'numeric' })

function formatAED(n: number) {
  return invoiceMoneyFormatter.format(n)
}
