...
// ⚡ Bolt: Cache Intl.NumberFormat to avoid repeated garbage collection and parsing overhead (~18x faster)
...
// ⚡ Bolt: Cache Intl.DateTimeFormat to avoid repeated garbage collection and parsing overhead (~18x faster)
