...
// Cache Intl formatters to prevent garbage collection overhead during render loops
...
const shortDateFormatter = new Intl.DateTimeFormat('en-AE', { day: '2-digit', month: 'short', year: 'numeric' })
