export default function SettingsPage() {
    return (
        <div className="space-y-6">
            ...
            <div className="rounded-3xl border border-gray-200 bg-white/50 backdrop-blur-xl p-8 shadow-sm flex flex-col items-center justify-center min-h-[400px] text-center">
                ...
                <p className="max-w-sm mt-2 text-sm text-gray-500">
                    We're currently building the settings interface. Check back soon!
                </p>
            </div>
        </div>
    )
